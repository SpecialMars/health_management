...
public class SMSUtils {
    ...
    private final static String SDKAppID = "1400629521";
    private final static String secretId = "AKIDlIabLo0vb2C5j6C1Zrsc5IEtHPGq9BxS";
    private final static String secretKey = "GFxFH3ZptiIdjZ9VbR2OVNzNXR5UeZEd";
    private final static String SDKAppKey = "801519e6b35a591c657ac8a77d6623fe";
    ...
    public static SmsSingleSenderResult sendCode(String phone, String nationCode, String code, Integer templateId) {
        int appid = 1400629521;
        String[] phoneNumbers = {phone}; //手机号可以添很多。
        String smsSign = "Mars健康公众号"; //短信签名
    ...
    public static void main(String[] args) {
        ...
        SendSmsResponse result = sendSms("1294824", "+86", "13720901513");
        // Integer code = ValidateCodeUtils.generateValidateCode(6);
        // SmsSingleSenderResult result2 = sendCode("13720901513", "+86", String.valueOf(code), 1294819);
